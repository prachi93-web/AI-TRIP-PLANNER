              ...
              <>
                <div className="mt-12 mb-5">
                  <h2 className="text-2xl font-bold text-gray-900">
                    Explore AI Sample Trips
                  </h2>

                  <p className="text-gray-500 mt-1">
                    View ready-made trips generated by AI.
                  </p>
                </div>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                        <div className="flex flex-col sm:flex-row gap-4 flex-1">
                          <div className="relative">
                            ...
                            <span className="absolute top-2 right-2 bg-white border border-purple-300 text-purple-700 text-xs font-semibold px-2 py-1 rounded-full shadow-sm">
                              Sample
                            </span>
                          </div>
                        ...
                        <button
                          onClick={() => navigate(`/trip/${trip._id}`)}
                          className="px-6 h-10 rounded-xl border border-purple-300 text-purple-700 hover:bg-purple-50 transition"
                        >
                          View
                        </button>
                      </div>
